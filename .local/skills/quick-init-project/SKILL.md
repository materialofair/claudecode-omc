...
- Use Agent(subagent_type="oh-my-claudecode:analyst", model="glm-5.2")
...
- Use Agent(subagent_type="oh-my-claudecode:architect", model="glm-5.2")
...
- Use Agent(subagent_type="oh-my-claudecode:planner", model="glm-5.2")
